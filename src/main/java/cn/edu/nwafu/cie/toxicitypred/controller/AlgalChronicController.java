...
public class AlgalChronicController {
     ...
     * 藻类慢性毒性记录的smi文件存放路径
     **/
    private static String trainDragonOutPath = System.getProperty("user.dir") + "/files/dragonoutfiles/algalchronic/trainfiles"; //smi文件路径（训练集）
    private static String vldDragonOutPath = System.getProperty("user.dir") + "/files/dragonoutfiles/algalchronic/vldfiles";  //smi文件路径（验证集）
